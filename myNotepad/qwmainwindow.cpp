...
void QWMainWindow::on_actionSave_triggered()
{
...
void QWMainWindow::on_actionSaveAs_triggered()
{
    QFormDoc* formDoc=(QFormDoc*)ui->mdiArea->activeSubWindow()->widget();
    formDoc->textSaveAs();
}
...
void QWMainWindow::on_actionUndo_triggered()
{
    QFormDoc* formDoc=(QFormDoc*)ui->mdiArea->activeSubWindow()->widget();
    formDoc->editUndo();
}
...
void QWMainWindow::on_actionRedo_triggered()
{
    QFormDoc* formDoc=(QFormDoc*)ui->mdiArea->activeSubWindow()->widget();
    formDoc->editRedo();
}
...
void QWMainWindow::on_actionAbout_triggered()
{
    AboutDialog dlg;
    dlg.exec();
}
...
void QWMainWindow::on_actionFind_triggered()
{
    QFormDoc* formDoc=(QFormDoc*)ui->mdiArea->activeSubWindow()->widget();
    formDoc->search();
}
...
void QWMainWindow::on_actionReplace_triggered()
{
    QFormDoc* formDoc=(QFormDoc*)ui->mdiArea->activeSubWindow()->widget();
    formDoc->replace();
}
